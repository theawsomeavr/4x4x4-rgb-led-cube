...
#define NOISE     8  // Noise/hum/interference in mic signal
...
void loop() {
  ...
  n   = analogRead(MIC_PIN)*4;                        // Raw reading from mic 
  ...
  /* Serial.print("X = ");  
   Serial.print(lvl);
   Serial.print(" Y = ");
   Serial.println(analogRead(MIC_PIN)-512);*/
// Serial.println(lvl);
...
if(culur==256){
  ...
  for(i=0; i<N_PIXELS; i++) {
    ...
    else strip.setPixelColor(i,Wheel(culur));
